...
export const routes: Routes = [
  { path: 'login', component: LoginComponent },
  {
    ...
    children: [
      ...
      { path: 'users', loadComponent: () => import('./users/users.component').then(m => m.UsersComponent), canActivate: [superGuard] },
      { path: 'masters', loadComponent: () => import('./masters/masters.component').then(m => m.MastersComponent), canActivate: [superGuard] }
    ]
  }
];
