...
export class ExpensesComponent implements OnInit {
  ...
  openAdd() { this.form = { ...this.blank(), category: this.activeTab }; this.editing = null; this.showModal = true; }
  openEdit(e: Expense) { this.form = { ...e }; this.editing = e; this.showModal = true; }

  save() {
    if (!this.form.name || this.form.amount <= 0) return;
